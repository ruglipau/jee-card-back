...
public class AppAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String role = user.getAuthorities().toArray(new GrantedAuthority[1])[0].getAuthority();
        ...
        String accessToken = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + 1000 * 60 * 10)) //L'access token dure 10 minutes
        ...
        String refreshToken = JWT.create()
                .withSubject(user.getUsername())
                .withIssuedAt(new Date(System.currentTimeMillis()))
                .withExpiresAt(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24)) //Le refresh token dure 24h
                .withIssuer(request.getRequestURL().toString())
                .sign(algorithm);
